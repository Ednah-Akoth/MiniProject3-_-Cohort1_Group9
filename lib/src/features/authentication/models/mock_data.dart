import 'package:job_finder/src/features/authentication/models/job_model.dart';
...
final popularJobs = [
  Job(
    ...
    qualifications: qualifications, type: 'bgbg',
  ),
  Job(
    id: 2,
    companyName: 'Airbnb, Inc.',
    ...
    location: 'Singapore, Permanent, Remote',
    responsibilities: responsibilities,
    qualifications: qualifications, type: 'hgfgfh',
  ),
  Job(
    id: 3,
    ...
    responsibilities: responsibilities,
    qualifications: qualifications, type: 'bgb',
  ),
];
...
final recentJobs = [
  ...
  Job(
    ...
    location: 'Singapore, Permanent',
    responsibilities: responsibilities,
    qualifications: qualifications, type: 'bggb',
  ),
];
